...
1     #ph fish4 sel
3     #ph srv sel - phase for estim. survey selectivity 
...
1.2   #prior mean for recruitment devs (sigr)  
...
5     #ph_q_srv2      // Phase for estimating catchability 2
...
1    # ph_ifq;
1    # ph_srv2q;
1   # yield ratio area 1 
1   # yield ratio area 2
1   # yield ratio area 3
